              ...
              <div className="col-12">
                <div className="footer-content text-center">
                  ...
                  <div className="footer-social-info">
                    <a key={"pinterest"} href="/" data-toggle="tooltip" data-placement="top" title="pinterest"><i
                      className="fa fa-pinterest" aria-hidden="true"></i></a>
                    <a key={"facebook"} href="/" data-toggle="tooltip" data-placement="top" title="facebook"><i
                      className="fa fa-facebook" aria-hidden="true"></i></a>
                    <a key={"twitter"} href="/" data-toggle="tooltip" data-placement="top" title="twitter"><i className="fa fa-twitter"
                                                                                              aria-hidden="true"></i></a>
                    <a key={"dribbble"} href="/" data-toggle="tooltip" data-placement="top" title="dribbble"><i
                      className="fa fa-dribbble" aria-hidden="true"></i></a>
                    <a key={"behance"} href="/" data-toggle="tooltip" data-placement="top" title="behance"><i className="fa fa-behance"
                                                                                              aria-hidden="true"></i></a>
                    <a key={"linkedin"} href="/" data-toggle="tooltip" data-placement="top" title="linkedin"><i
