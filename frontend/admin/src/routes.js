...
const ArticlesCreate = React.lazy(() => import('./views/Article/ArticleCreate'));
...
const routes = [
  ...
  { path: '/articles/add', exact: true, name: 'Create Article', component: ArticlesCreate },
  { path: '/articles/:page', exact: true, name: 'Articles', component: Article },
